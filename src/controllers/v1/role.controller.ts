...
export const getAllRole = async (req: AuthenticatedRequest, res: Response) => {
  try {
    ...
    return successResponse(res, "Success get all global role", roles,{
      limit,
      offset,
      total: count,
...
export const getRoleById = async (req: AuthenticatedRequest, res: Response) => {
  try {
    ...
    return successResponse(res, "Success get global role by id", role);
  } catch (error: unknown) {
    if (
      error instanceof ValidationError ||
      error instanceof UniqueConstraintError
...
export const createRole = async (req: AuthenticatedRequest, res: Response) => {
  try {
    const { kode, role, service_kode, description } = req.body;
    if (!kode || !role || !service_kode) {
      return errorResponse(res, "Missing required parameters", null, 400);
    }
...
export const updateRole = async (req: AuthenticatedRequest, res: Response) => {
  try {
    ...
    await data.save();
    return successResponse(res, "Success update role", data);
  } catch (error: unknown) {
    if (
      error instanceof ValidationError ||
      error instanceof UniqueConstraintError
...
export const deleteRole = async (req: AuthenticatedRequest, res: Response) => {
  try {
    ...
    await role.destroy();
    return successResponse(res, "Success delete role", role);
  } catch (error: unknown) {
    if (
      error instanceof ValidationError ||
      error instanceof UniqueConstraintError
